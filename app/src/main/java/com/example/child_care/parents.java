...
public class parents extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sign.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent na= new Intent(parents.this,P_reg.class);
                startActivity(na);
            }
        });
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                firebaseAuth.signInWithEmailAndPassword(email, pass)
                        .addOnCompleteListener((Activity) parents.this, new OnCompleteListener<AuthResult>() {
                            @Override
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful()) {
                                    ...
                                    startActivity(new Intent(parents.this,parents_home.class));
                                } else {
